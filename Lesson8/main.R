...
gewata$VCF_diff2 <- (gewata$VCF_diff)^2
...
# Gives proper formatting to matrix
colnames(RMSE_classes) <- c('class', 'RMSE')
class_names <- levels(trainingPoly@data$Class)
RMSE_classes[,1] <- class_names[RMSE_classes[,1]]
print(RMSE_classes)
